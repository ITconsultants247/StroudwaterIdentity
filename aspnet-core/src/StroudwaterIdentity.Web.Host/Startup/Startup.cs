...
using Owin;
using Abp.Owin;
using StroudwaterIdentity.Owin;
...
namespace StroudwaterIdentity.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "StroudwaterIdentity API", Version = "v1" });
            ...
            return services.AddAbp<StroudwaterIdentityWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "StroudwaterIdentity API V1");
            }); // URL: /swagger
        }
        ...
        {
            app.Properties["host.AppName"] = "StroudwaterIdentity";
